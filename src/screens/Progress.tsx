...
import { progressData as fallbackProgress } from '../data/mockData'
import { useEffect, useState } from 'react'
import { api } from '../lib/api'

export default function Progress() {
  const [progressData, setProgressData] = useState<any>(fallbackProgress)
  useEffect(() => { api<any>('/progress').then(setProgressData).catch(() => {}) }, [])
